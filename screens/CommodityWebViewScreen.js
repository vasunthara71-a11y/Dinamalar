...
export default function CommodityWebViewScreen({ navigation, route }) {
  const { sf } = useFontSize();
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(false);
  
  const url = route?.params?.url || 'https://www.dinamalar.com/news/business-commodity';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { fontSize: sf(18) }]}>வணிகம்</Text>
