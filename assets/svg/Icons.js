...
export const EditorChoice = ({ color = 'currentColor', size = 20, style = {} }) => (
  <Svg 
    stroke={color} 
    fill={color} 
    strokeWidth="0" 
...
export const VideoPlayButton = ({ color = '#FFFFFF', size = 24, style = {} }) => (
  <Svg 
    stroke={color} 
    fill={color} 
    strokeWidth="0" 
...
export const SunIcon = ({ color = 'currentColor', size = 20, style = {} }) => (
  <Svg 
    stroke="currentColor" 
    fill="currentColor" 
    strokeWidth="0" 
